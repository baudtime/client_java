...
public class MultiEndpointClient implements Client {
    ...
    public LabelValuesResponse labelValues(String name, Date start, Date end, long timeout, TimeUnit unit) {
        checkCurrentSelect();
        return current.labelValues(name, start, end, timeout, unit);
    }
    ...
    public LabelValuesResponse labelValues(String endpoint, String name, Date start, Date end, long timeout, TimeUnit unit) {
        return getClient(endpoint).labelValues(name, start, end, timeout, unit);
    }
