...
@AllArgsConstructor
@NoArgsConstructor
public class BaudtimeInstantQuery<R> implements BaudtimeQuery<R> {
    ...
    public R run() throws BaudtimeQueryException {
        try {
            ...
            QueryResponse response = baudtimeClient.instantQuery(this.getQueryExp(), time, queryTimeoutSec, TimeUnit.SECONDS);
